...
- External images: Kinsta wordmark; slideshow: M-Dot **YouTube channel avatar** at max Google CDN size (`=s8192`), then *Library of Sound* (Apple Music CDN), then *egO anD The eneMy* cover (Bandcamp CDN). Slides are not linked.
